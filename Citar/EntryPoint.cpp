...
#include "..\CitarVS\Inference\KeywordExtractor.h"
#include <Windows.h>
...
const std::string simplifiedNGrams = "C:\\Apps\\KeywordExtraction\\Citar\\brown-simplified.ngrams";
const std::string simplifiedNGrameLexicon = "C:\\Apps\\KeywordExtraction\\Citar\\brown-simplified.lexicon";
...
extern "C"  __declspec(dllexport) void InitializeModel()
{
	...
	args.push_back(simplifiedNGrams);
	args.push_back(simplifiedNGrameLexicon);
	if(InitModel(args) != 0)
	{
